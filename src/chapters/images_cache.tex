...
%         \end{scope}
%         \begin{scope}[every node/.style={color=black}]
%             \node (1c) [above=1pt of 1, color=red] {1};
...
%         \end{scope}
%     \end{tikzpicture}
%     \caption{Vertex coloring consistency under switching}
% \end{figure}
...
%         \end{scope}
%     \end{tikzpicture}
%     \caption[Edge coloring consistency under switching]{Edge coloring consistency under switching. Note the special behavior of the color $0$: the sign of edges colored $0$ is irrelevant.}
% \end{figure}
