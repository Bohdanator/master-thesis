...
%                 \path
%                     (1) edge (2)
%                     (3) edge [colour=red, ultra thick] (4)
%                     (4) edge [colour=blue] (7)
%                     (5) edge [colour=red, ultra thick] (2)
%                     (6) edge [colour=red, ultra thick] (3);
%             \end{scope}
%             \begin{scope}[every every edge/.style={draw,very thick}]
%                 \path
%                     (1) edge [colour=red, ultra thick] (6)
%                     (2) edge [colour=red, ultra thick] (4)
%                     (3) edge (1)
%                     (4) edge [colour=blue] (5)
%                     (4) edge [colour=blue] (6);
%             \end{scope}
...
%             \begin{scope}[every edge/.style={draw,dashed,very thick}]
%                 \path
%                     (21) edge [colour=red, ultra thick] (41)
%                     (11) edge [colour=red, ultra thick] (61)
%                     (11) edge (21)
%                     (41) edge [colour=blue] (71);
%             \end{scope}
%             \begin{scope}[every edge/.style={draw,very thick}]
%                 \path
%                     (31) edge (11)
%                     (41) edge [colour=blue] (51)
%                     (41) edge [colour=blue] (61)
%                     (31) edge [colour=red, ultra thick] (41)
%                     (51) edge [colour=red, ultra thick] (21)
%                     (61) edge [colour=red, ultra thick] (31);
%             \end{scope}
%         \end{tikzpicture}
%     \caption[Switching example]{Switching example. Note that switching blue vertices and switching grey vertices results in the same transformation.}
% \end{figure}
